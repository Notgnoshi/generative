#pragma once
#include "geom2graph/io/graph-reader.h"
...
public:
    ...
    geom2graph::noding::GeometryGraph read() noexcept override;
    void read(const std::string& line) noexcept override;

private:
    std::list<geom2graph::noding::GeometryGraph::Node> m_nodes_list;
    std::vector<geom2graph::noding::GeometryGraph::Node> m_nodes_vec;
